...
I'm sitting with some VP of Data or Chief Analytics Officer. Smart person. Big title. And at some point I say "entropy."
...
Make coffee. Pour in cream. Watch those white ribbons curl through the black. Beautiful for about two seconds. Then it's brown. Mixed. Done.
...
Here's what bothers people: physics says it's allowed. Every molecule could, in theory, wander back to where it started. The math permits it.
...
![The Weight of Chance](/content/images/2025/12/the-weight-of-chance.png)
...
[Ludwig Boltzmann](https://grokipedia.com/page/Ludwig_Boltzmann) figured this out in Vienna in the 1870s. Spent his whole career defending it while his colleagues called him crazy. He had the equation carved on his tombstone: S = k log W. Then he killed himself in 1906, convinced he'd wasted his life.

Ten years later, every physics textbook in the world taught his ideas as settled fact.

I don't know what to do with that story. But I think about it a lot.
...
![The Only Way Is Forward](/content/images/2025/12/only-way-is-forward.png)
...
Christopher Nolan spent $200 million on TENET trying to fake time running backwards. Bullets flying into guns. Explosions reassembling. Let me correct this. He didn't fake it with CGI, but he cheated. He filmed actors walking backwards. Drove cars in reverse. Blew things up backwards and flipped the footage. Two hundred million dollars and the only solution was practical effects.
...
1948. Bell Labs. An engineer named [Claude Shannon](https://grokipedia.com/page/Claude_Shannon) is trying to answer a simple question: how do you measure information?
...
![Different Worlds, Same Equation](/content/images/2025/12/different-worlds-same-equation.png)
...
![Nobody Built This](/content/images/2025/12/nobody-built-this.png)
...
Data decays the same way. Column called `customer_status`. String type. Values: "active" or "inactive." Six months ago "active" meant "logged in within 30 days." Then Product changed it to mean "has a valid subscription." Nobody told the data team.

Same column. Same values. Completely different meaning.

![Semantic Drift](/content/images/2025/12/semantic-drift.png)
...
I spent time at a military academy in Tunisia. I don't talk about it much. It was hard.

But one thing stuck: the difference between amateurs and professionals isn't talent. It's not skill either.
...
**Lock down definitions.** When "revenue" means five things in five systems, that's entropy. Fix it with an ontology: formal, versioned, governed. One definition, pushed everywhere. [Dave McComb](https://www.amazon.com/Data-Centric-Revolution-Restoring-Enterprise/dp/1634625404) has been writing about this for decades. Almost nobody listens.
...
*If you build data systems and want honest takes on problems vendors won't touch, [subscribe to Against Entropy](#).*

---

## Further Reading

[Sean Carroll, "From Eternity to Here"](https://www.amazon.com/Eternity-Here-Quest-Ultimate-Theory/dp/0452296544) — Best book on entropy and time.

[James Gleick, "The Information"](https://www.amazon.com/Information-History-Theory-Flood/dp/1400096235) — Shannon's story.

[Dave McComb, "The Data-Centric Revolution"](https://www.amazon.com/Data-Centric-Revolution-Restoring-Enterprise/dp/1634625404) — Your data problems are architecture problems.

[The Two Ways Your Data Lies to You](/two-ways-data-lies) — Syntactic versus semantic drift.
